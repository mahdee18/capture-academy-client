        ...
        <Fade direction="up" triggerOnce>
            <div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                    {data.map((instructor) => (
                        <div
                            className="w-full relative mt-16 bg-green-400 rounded-xl pt-16 text-center p-6"
                            key={instructor._id}
                        >
                            <div className="w-32 h-32 rounded-full p-2 overflow-hidden absolute z-10 top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
                                <img
